...
exports.post_login=async(req,res)=>{
    ...
    if(user.isActive==false){
        req.session.message={text:`Görünüşe göre hesabınız henüz aktif edilmemiş. Hesabınızı aktif etmek için e-postanıza gelen linki kullanarak hesabınız aktif edebilirsiniz`, class:"warning"};
        return res.redirect("/auth/login");
    }
